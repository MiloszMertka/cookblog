...
public class RecipeTests {
    ...
    public void givenRecipeData_WhenCreateRecipe_ThenSeeRecipe() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//mat-option/span[contains(text(),'libero')]")).click();
    ...
    public void givenRecipe_WhenRead_ThenShouldRead() throws InterruptedException {
        ...
        final var imageElement = driver.findElement(By.xpath("//img[contains(@src,'" + imagePath + "')]"));
        assertThat(imageElement.isDisplayed()).isTrue();
    ...
    public void givenRecipe_WhenEdit_ThenSeeEditedRecipe() throws InterruptedException {
        ...
        final var ingredientNameEdited = "EditedIngredient";
        final var amountEdited = "62";
        ...
        categoryDropDown.click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//mat-option/span[contains(text(),'dicta')]")).click();
        ...
        final var ingredientNameInput = driver.findElement(By.cssSelector("input[data-test-id='ingredient-name']"));
        ingredientNameInput.clear();
        ingredientNameInput.sendKeys(ingredientNameEdited);
        Thread.sleep(300);

        final var amountValueInput = driver.findElement(By.cssSelector("input[data-test-id=\"ingredient-amount\"]"));
        amountValueInput.clear();
        amountValueInput.sendKeys(amountEdited);
        Thread.sleep(300);
        ...
        assertThat(portionsElement.isDisplayed()).isTrue();
        final var ingredientElement = driver.findElement(By.xpath("//*[contains(normalize-space(),'" + ingredientNameEdited + "')]"));
        assertThat(ingredientElement.isDisplayed()).isTrue();
        final var amountElement = driver.findElement(By.xpath("//*[contains(normalize-space(),'" + amountEdited + "')]"));
        assertThat(amountElement.isDisplayed()).isTrue();
        final var imageElement = driver.findElement(By.xpath("//img[contains(@src,'" + imagePathEdited + "')]"));
        assertThat(imageElement.isDisplayed()).isTrue();
    }
    ...
    public void givenRecipe_WhenDeleteRecipe_ThenRecipeIsRemoved() throws InterruptedException {
        ...
        final var recipeTitleEdited = "Editedmytitle";
        final var deleteButton = driver.findElement(By.cssSelector("button[aria-label='deleteRecipeButton']"));
        deleteButton.click();
        ...
        driver.navigate().to(APP_URL);
        clickNextUntilDisabled();
        assertThat(driver.findElements(By.xpath("//*[contains(text(),'" + recipeTitleEdited + "')]")).isEmpty()).isTrue();
    }
}
